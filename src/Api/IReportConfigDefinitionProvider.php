...
/**
 * Provides declarative report configurations for one logical scope.
 */
interface IReportConfigDefinitionProvider extends IBase {

	/**
	 * Returns the logical report scope used for diagnostics and uniqueness.
	 */
	public function getScope(): string;

	/**
	 * Returns named report definition datasets.
	 *
