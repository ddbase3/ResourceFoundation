...
/**
 * Exposes materialization manifests grouped by independent target scope.
 */
interface IScopedMaterializationManifestProvider extends IMaterializationManifestProvider {
