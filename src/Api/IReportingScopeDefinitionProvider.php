...
/**
 * Provides one user-facing reporting scope.
 */
interface IReportingScopeDefinitionProvider extends IBase {

	public function getReportingScopeDefinition(): ReportingScopeDefinition;
}
