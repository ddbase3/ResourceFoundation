...
/**
 * Provides declarative materialization definitions for one logical scope.
 */
interface IMaterializationDefinitionProvider extends IBase {

	/**
	 * Returns the logical target schema scope for the materializations.
	 */
